...
jclass _getClassID(const char *className) {
    ...
    JNIEnv* env = vnc::JniHelper::getEnv();

    jstring _jstrClassName = env->NewStringUTF(className);

    jclass _clazz = (jclass) env->CallObjectMethod(vnc::JniHelper::classloader,
                                                    vnc::JniHelper::loadclassMethod_methodID, 
                                                    _jstrClassName);
...
void _detachCurrentThread(void* a) {
    vnc::JniHelper::getJavaVM()->DetachCurrentThread();
}
...
namespace vnc {
	...
	bool JniHelper::setClassLoaderFrom(jobject activityinstance) {
		...
		jobject _c = vnc::JniHelper::getEnv()->CallObjectMethod(activityinstance,
		...
		JniHelper::classloader = vnc::JniHelper::getEnv()->NewGlobalRef(_c);
