...
#define T2P_CMD_GET_TV_BASEINFO						    (0x0002001E)
#define T2P_RET_GET_TV_BASEINFO                         (0x0002001F)
//#define T2P_CMD_PUSH_UPGRADE_CHECK                      (0x00020020)
#define T2P_CMD_UPGRADE_CHECK                           (0x00020022)
